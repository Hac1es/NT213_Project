<template>
  <div
    class="min-h-screen flex flex-col items-start justify-start bg-[#101014] text-white"
  >
    <div class="w-[80%] mx-auto mb-12 mt-6">
      ...
      <div
        class="bg-[#18181c] border border-gray-700 rounded-lg p-6 relative overflow-hidden"
      >
        ...
        >
          ...
          <p class="text-lg text-gray-400">
            ...
            <strong>N/A</strong> (Not Applicable) and exclude them from the
            score calculation.
          </p>
        </div>
      </div>
    ...
    <div class="w-[80%] mx-auto">
      <div class="mb-10">
        <h1 class="text-3xl font-medium text-[#63e2b7]">
        ...
        <ClickCriteria
          ...
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V1.1.2."
        ...
        <ClickCriteria
          heading="V1.4.1."
          title="Verify that trusted enforcement points, such as access control gateways, servers, and serverless functions, enforce access controls. Never enforce access controls on the client."
        />
        <ClickCriteria
          heading="V1.4.4."
        ...
        <ClickCriteria
          heading="V1.6.4."
          title="Verify that the architecture treats client-side secrets--such as symmetric keys, passwords, or API tokens--as insecure and never uses them to protect or access sensitive data."
        />
        <ClickCriteria
          heading="V1.7.1."
        ...
        <ClickCriteria
          heading="V1.14.2."
          title="Verify that binary signatures, trusted connections, and verified endpoints are used to deploy binaries to remote devices."
        />
        <ClickCriteria
          heading="V1.14.3."
      ...
      <div class="mb-10">
        <h1 class="text-3xl font-medium text-[#63e2b7] pb-1 mt-8">
          Chapter V2: Authentication
        </h1>
        <ClickCriteria
          heading="V2.1.1."
          title="Verify that user set passwords are at least 12 characters in length (after multiple spaces are combined)."
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V2.1.2."
          title="Verify that passwords of at least 64 characters are permitted, and that passwords of more than 128 characters are denied."
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V2.1.3."
          title="Verify that password truncation is not performed. However, consecutive multiple spaces may be replaced by a single space."
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V2.1.4."
          title="Verify that any printable Unicode character, including language neutral characters such as spaces and Emojis are permitted in passwords."
        />
        <ClickCriteria
          heading="V2.1.5."
        ...
        <ClickCriteria
          heading="V2.1.12."
          title="Verify that the user can choose to either temporarily view the entire masked password, or temporarily view the last typed character of the password on platforms that do not have this as built-in functionality."
        />
        <ClickCriteria
          heading="V2.2.1."
        ...
        <ClickCriteria
          heading="V2.2.6."
          title="Verify replay resistance through the mandated use of One-time Passwords (OTP) devices, cryptographic authenticators, or lookup codes."
        />
        <ClickCriteria
          heading="V2.2.7."
        ...
        <ClickCriteria
          heading="V2.3.2."
          title="Verify that enrollment and use of user-provided authentication devices are supported, such as a U2F or FIDO tokens."
        />
        <ClickCriteria
          heading="V2.3.3."
        ...
        <ClickCriteria
          heading="V2.4.4."
          title="Verify that if bcrypt is used, the work factor SHOULD be as large as verification server performance will allow, with a minimum of 10."
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V2.4.5."
        ...
        <ClickCriteria
          heading="V2.5.6."
          title="Verify forgotten password, and other recovery paths use a secure recovery mechanism, such as time-based OTP (TOTP) or other soft token, mobile push, or another offline recovery mechanism."
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V2.5.7."
        ...
        <ClickCriteria
          heading="V2.8.3."
          title="Verify that approved cryptographic algorithms are used in the generation, seeding, and verification of OTPs."
        />
        <ClickCriteria
          heading="V2.8.4."
        ...
        <ClickCriteria
          heading="V2.9.1."
          title="Verify that cryptographic keys used in verification are stored securely and protected against disclosure, such as using a Trusted Platform Module (TPM) or Hardware Security Module (HSM), or an OS service that can use this secure storage."
        />
        <ClickCriteria
          heading="V2.9.2."
        ...
        <ClickCriteria
          heading="V2.10.1."
          title="Verify that intra-service secrets do not rely on unchanging credentials such as passwords, API keys or shared accounts with privileged access."
        />
        <ClickCriteria
          heading="V2.10.2."
          title="Verify that if passwords are required for service authentication, the service account used is not a default credential. (e.g. root/root or admin/admin are default in some services during installation)."
        />
        <ClickCriteria
          heading="V2.10.3."
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V3.1.1."
          title="Verify the application never reveals session tokens in URL parameters."
        />
        <ClickCriteria
          heading="V3.2.1."
        ...
        <ClickCriteria
          heading="V3.2.4."
          title="Verify that session tokens are generated using approved cryptographic algorithms."
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V3.3.1."
        ...
        <ClickCriteria
          heading="V3.3.3."
          title="Verify that the application gives the option to terminate all other active sessions after a successful password change (including change via password reset/recovery), and that this is effective across the application, federated login (if present), and any relying parties."
        />
        <ClickCriteria
          heading="V3.3.4."
          title="Verify that users are able to view and (having re-entered login credentials) log out of any or all currently active sessions and devices."
        />
        <ClickCriteria
          heading="V3.4.1."
        ...
        <ClickCriteria
          heading="V3.4.4."
          title='Verify that cookie-based session tokens use the "__Host-" prefix so cookies are only sent to the host that initially set the cookie.'
        />
        <ClickCriteria
          heading="V3.4.5."
          title="Verify that if the application is published under a domain name with other applications that set or use session cookies that might disclose the session cookies, set the path attribute in cookie-based session tokens using the most precise path possible."
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V3.5.1."
          title="Verify the application allows users to revoke OAuth tokens that form trust relationships with linked applications."
        />
        <ClickCriteria
          heading="V3.5.2."
        ...
        <ClickCriteria
          heading="V3.6.1."
          title="Verify that Relying Parties (RPs) specify the maximum authentication time to Credential Service Providers (CSPs) and that CSPs re-authenticate the user if they haven't used a session within that period."
        />
        <ClickCriteria
          heading="V3.6.2."
          title="Verify that Credential Service Providers (CSPs) inform Relying Parties (RPs) of the last authentication event, to allow RPs to determine if they need to re-authenticate the user."
        />
        <ClickCriteria
          heading="V3.7.1."
          title="Verify the application ensures a full, valid login session or requires re-authentication or secondary verification before allowing any sensitive transactions or account modifications."
        />
      </div>
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V4.2.1."
          title="Verify that sensitive data and APIs are protected against Insecure Direct Object Reference (IDOR) attacks targeting creation, reading, updating and deletion of records, such as creating or updating someone else's record, viewing everyone's records, or deleting all records."
        />
        <ClickCriteria
          heading="V4.2.2."
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V5.1.3."
          title="Verify that all input (HTML form fields, REST requests, URL parameters, HTTP headers, cookies, batch files, RSS feeds, etc) is validated using positive validation (allow lists)."
        />
        <ClickCriteria
          heading="V5.1.4."
          title="Verify that structured data is strongly typed and validated against a defined schema including allowed characters, length and pattern (e.g. credit card numbers, e-mail addresses, telephone numbers, or validating that two related fields are reasonable, such as checking that suburb and zip/postcode match). "
        />
        <ClickCriteria
          heading="V5.1.5."
          title="Verify that URL redirects and forwards only allow destinations which appear on an allow list, or show a warning when redirecting to potentially untrusted content."
        />
        <ClickCriteria
          heading="V5.2.1."
        ...
        <ClickCriteria
          heading="V5.2.6."
          title="Verify that the application protects against SSRF attacks, by validating or sanitizing untrusted data or HTTP file metadata, such as filenames and URL input fields, and uses allow lists of protocols, domains, paths and ports."
        />
        <ClickCriteria
          heading="V5.2.7."
          title="Verify that the application sanitizes, disables, or sandboxes user-supplied Scalable Vector Graphics (SVG) scriptable content, especially as they relate to XSS resulting from inline scripts, and foreignObject."
        />
        <ClickCriteria
          heading="V5.2.8."
        ...
        <ClickCriteria
          heading="V5.3.6."
          title="Verify that the application protects against JSON injection attacks, JSON eval attacks, and JavaScript expression evaluation. "
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V5.3.7."
        ...
        <ClickCriteria
          heading="V5.5.2."
          title="Verify that the application correctly restricts XML parsers to only use the most restrictive configuration possible and to ensure that unsafe features such as resolving external entities are disabled to prevent XML eXternal Entity (XXE) attacks."
        />
        <ClickCriteria
          heading="V5.5.3."
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V7.2.1."
          title="Verify that all authentication decisions are logged, without storing sensitive session tokens or passwords. This should include requests with relevant metadata needed for security investigations."
        />
        <ClickCriteria
          heading="V7.2.2."
        ...
        <ClickCriteria
          heading="V7.3.1."
          title="Verify that all logging components appropriately encode data to prevent log injection."
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V7.3.3."
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V8.2.2."
          title="Verify that data stored in browser storage (such as localStorage, sessionStorage, IndexedDB, or cookies) does not contain sensitive data."
        />
        <ClickCriteria
          heading="V8.2.3."
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V9.1.2."
          title="Verify using up to date TLS testing tools that only strong cipher suites are enabled, with the strongest cipher suites set as preferred."
        />
        <ClickCriteria
          heading="V9.1.3."
          title="Verify that only the latest recommended versions of the TLS protocol are enabled, such as TLS 1.2 and TLS 1.3. The latest version of the TLS protocol should be the preferred option."
        />
        <ClickCriteria
          heading="V9.2.1."
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V10.2.4."
          title="Verify that the application source code and third party libraries do not contain time bombs by searching for date and time related functions."
        />
        <ClickCriteria
          heading="V10.2.5."
          title="Verify that the application source code and third party libraries do not contain malicious code, such as salami attacks, logic bypasses, or logic bombs."
        />
        <ClickCriteria
          heading="V10.2.6."
        ...
        <ClickCriteria
          heading="V10.3.2."
          title="Verify that the application employs integrity protections, such as code signing or subresource integrity. The application must not load or execute code from untrusted sources, such as loading includes, modules, plugins, code, or libraries from untrusted sources or the Internet."
        />
        <ClickCriteria
          heading="V10.3.3."
          title="Verify that the application has protection from subdomain takeovers if the application relies upon DNS entries or DNS subdomains, such as expired domain names, out of date DNS pointers or CNAMEs, expired projects at public source code repos, or transient cloud APIs, serverless functions, or storage buckets (*autogen-bucket-id*.cloud.example.com) or similar. Protections can include ensuring that DNS names used by applications are regularly checked for expiry or change."
        />
      </div>
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V11.1.1."
          title="Verify that the application will only process business logic flows for the same user in sequential step order and without skipping steps."
        />
        <ClickCriteria
          heading="V11.1.2."
          title="Verify that the application will only process business logic flows with all steps being processed in realistic human time, i.e. transactions are not submitted too quickly."
        />
        <ClickCriteria
          heading="V11.1.3."
        ...
        <ClickCriteria
          heading="V11.1.4."
          title="Verify that the application has anti-automation controls to protect against excessive calls such as mass data exfiltration, business logic requests, file uploads or denial of service attacks."
        />
        <ClickCriteria
          heading="V11.1.5."
          title="Verify the application has business logic limits or validation to protect against likely business risks or threats, identified using threat modeling or similar methodologies."
        />
        <ClickCriteria
          heading="V11.1.6."
          title='Verify that the application does not suffer from "Time Of Check to Time Of Use" (TOCTOU) issues or other race conditions for sensitive operations.'
        />
        <ClickCriteria
          heading="V11.1.7."
          title="Verify that the application monitors for unusual events or activity from a business logic perspective. For example, attempts to perform actions out of order or actions which a normal user would never attempt."
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V11.1.8."
          title="Verify that the application has configurable alerting when automated attacks or unusual activity is detected."
        />
      </div>
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V12.1.1."
          title="Verify that the application will not accept large files that could fill up storage or cause a denial of service."
        />
        <ClickCriteria
          heading="V12.1.2."
          title="Verify that the application checks compressed files (e.g. zip, gz, docx, odt) against maximum allowed uncompressed size and against maximum number of files before uncompressing the file."
        />
        <ClickCriteria
          heading="V12.1.3."
        ...
        <ClickCriteria
          heading="V12.3.1."
          title="Verify that user-submitted filename metadata is not used directly by system or framework filesystems and that a URL API is used to protect against path traversal."
        />
        <ClickCriteria
          heading="V12.3.2."
        ...
        <ClickCriteria
          heading="V12.3.3."
          title="Verify that user-submitted filename metadata is validated or ignored to prevent the disclosure or execution of remote files via Remote File Inclusion (RFI) or Server-side Request Forgery (SSRF) attacks."
        />
        <ClickCriteria
          heading="V12.3.4."
        ...
        <ClickCriteria
          heading="V12.4.1."
          title="Verify that files obtained from untrusted sources are stored outside the web root, with limited permissions."
        />
        <ClickCriteria
          heading="V12.4.2."
          title="Verify that files obtained from untrusted sources are scanned by antivirus scanners to prevent upload and serving of known malicious content."
        />
        <ClickCriteria
          heading="V12.5.1."
        ...
        <ClickCriteria
          heading="V12.6.1."
          title="Verify that the web or application server is configured with an allow list of resources or systems to which the server can send requests or load data/files from."
        />
      </div>
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V13.2.3."
          title="Verify that RESTful web services that utilize cookies are protected from Cross-Site Request Forgery via the use of at least one or more of the following: double submit cookie pattern, CSRF nonces, or Origin request header checks."
        />
        <ClickCriteria
          heading="V13.2.5."
        ...
        <ClickCriteria
          heading="V13.4.1."
          title="Verify that a query allow list or a combination of depth limiting and amount limiting is used to prevent GraphQL or data layer expression Denial of Service (DoS) as a result of expensive, nested queries. For more advanced scenarios, query cost analysis should be used."
        />
        <ClickCriteria
          heading="V13.4.2."
      ...
      <div class="mb-10">
        ...
        <ClickCriteria
          heading="V14.2.2."
          title="Verify that all unneeded features, documentation, sample applications and configurations are removed."
        />
        <ClickCriteria
          heading="V14.2.3."
          title="Verify that if application assets, such as JavaScript libraries, CSS or web fonts, are hosted externally on a Content Delivery Network (CDN) or external provider, Subresource Integrity (SRI) is used to validate the integrity of the asset."
        />
        <ClickCriteria
          heading="V14.2.4."
        ...
        <ClickCriteria
          heading="V14.2.5."
          title="Verify that a Software Bill of Materials (SBOM) is maintained of all third party libraries in use."
          reference="https://owasp.org/www-project-proactive-controls/#div-numbering"
        />
        <ClickCriteria
          heading="V14.2.6."
        ...
        <ClickCriteria
          heading="V14.4.1."
          title="Verify that every HTTP response contains a Content-Type header. Also specify a safe character set (e.g., UTF-8, ISO-8859-1) if the content types are text/*, /+xml and application/xml. Content must match with the provided Content-Type header."
        />
        <ClickCriteria
          heading="V14.4.2."
          title='Verify that all API responses contain a Content-Disposition: attachment; filename="api.json" header (or other appropriate filename for the content type).'
        />
        <ClickCriteria
          heading="V14.4.3."
          title="Verify that a Content Security Policy (CSP) response header is in place that helps mitigate impact for XSS attacks like HTML, DOM, JSON, and JavaScript injection vulnerabilities."
        />
        <ClickCriteria
          heading="V14.4.4."
          title="Verify that all responses contain a X-Content-Type-Options: nosniff header."
        />
        <ClickCriteria
          heading="V14.4.5."
          title="Verify that a Strict-Transport-Security header is included on all responses and for all subdomains, such as Strict-Transport-Security: max-age=15724800; includeSubdomains."
        />
        <ClickCriteria
          heading="V14.4.6."
          title="Verify that a suitable Referrer-Policy header is included to avoid exposing sensitive information in the URL through the Referer header to untrusted parties."
        />
        <ClickCriteria
          heading="V14.4.7."
          title="Verify that the content of a web application cannot be embedded in a third-party site by default and that embedding of the exact resources is only allowed where necessary by using suitable Content-Security-Policy: frame-ancestors and X-Frame-Options response headers."
        />
        <ClickCriteria
          heading="V14.5.1."
          title="Verify that the application server only accepts the HTTP methods in use by the application/API, including pre-flight OPTIONS, and logs/alerts on any requests that are not valid for the application context."
        />
        <ClickCriteria
          heading="V14.5.2."
        ...
        <ClickCriteria
          heading="V14.5.3."
          title='Verify that the Cross-Origin Resource Sharing (CORS) Access-Control-Allow-Origin header uses a strict allow list of trusted domains and subdomains to match against and does not support the "null" origin.'
        />
        <ClickCriteria
          heading="V14.5.4."
